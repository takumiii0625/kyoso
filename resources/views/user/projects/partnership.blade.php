...
<head>
    ...
    <meta name="description" content="地域循環油プロジェクトの共創ネットワーク。自治体・企業・NPO・町内会と連携し、横浜市金沢区で継続できる循環の仕組みを構築しています。">
    <meta name="keywords" content="地域循環油,共創ネットワーク,地域連携,横浜市金沢区,NPO,企業連携,官民連携,SDGs">
    <meta property="og:title" content="共創ネットワーク | 地域循環油プロジェクト">
    <meta property="og:description" content="地域循環油プロジェクトの共創ネットワーク。自治体・企業・NPO・町内会と連携し継続できる循環の仕組みを構築。">
    ...
    <title>共創ネットワーク | 地域循環油プロジェクト | 株式会社共創</title>
    <style>
        :root {
            --ink: #101317;
            --muted: #6a7689;
