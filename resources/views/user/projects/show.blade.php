...
<head>
    ...
    <meta property="og:title" content="地域循環油プロジェクト概要 | 株式会社共創">
    <meta property="og:description" content="地域循環油プロジェクトの概要。回収拠点づくり、学校教育、共創ネットワークで廃食油を地域の資源に。">
    ...
    <title>地域循環油プロジェクト概要 | 株式会社共創</title>
    <style>
        :root {
            --ink: #1a1a1a;
            --muted: #657287;
        ...
        .hero {
            --hero-img: url('../image/授業風景_hero.jpg');
