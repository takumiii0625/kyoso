    ...
    <div class="container">
        ...
        <form method="post" action="{{ route('process') }}"> <!-- このrouteの部分はフォームを送信するための適切なルート名に置き換えてください -->
            ...
            <div class="form-group row">
                <p class="col-sm-4 col-form-label">お名前（10文字以内）<span class="badge bg-danger ms-1">必須</span></p>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <p class="col-sm-4 col-form-label">メールアドレス<span class="badge bg-danger ms-1">必須</span></p>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <p class="col-sm-4 col-form-label">会社名<span class="badge bg-secondary ms-1">任意</span></p>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                <p class="col-sm-4 col-form-label">お問い合わせ内容<span class="badge bg-danger ms-1">必須</span></p>
                <div class="col-sm-8">
            ...
            <div class="s">
                <button type="submit" name="action" value="submit" class="btn me-3" style="background-color: #ffa2a8; color: #fff;">送信</button>
                <button type="submit" name="action" value="return" class="btn btn-outline-secondary">戻る</button> <!-- このrouteの部分はお問い合わせフォームページへ戻るための適切なルート名に置き換えてください -->
            </div>
        </form>
    </div>
    <footer>
